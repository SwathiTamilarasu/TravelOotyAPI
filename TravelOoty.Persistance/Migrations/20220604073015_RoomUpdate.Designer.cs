...
namespace TravelOoty.Persistance.Migrations
{
    ...
    [Migration("20220604073015_RoomUpdate")]
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Amenities", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AmenitiesId = 1,
                            CreatedDate = new DateTime(2022, 6, 4, 7, 30, 14, 720, DateTimeKind.Utc).AddTicks(7701),
                            LastModifiedDate = new DateTime(2022, 6, 4, 7, 30, 14, 720, DateTimeKind.Utc).AddTicks(7705),
                            Name = "Parking"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Hotel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HotelId = new Guid("b5dffcf6-449d-4154-bf1f-cffa78580d05"),
                            Name = "Shaaniya"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.HotelCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            HotelCategoryId = 1,
                            CreatedDate = new DateTime(2022, 6, 4, 7, 30, 14, 720, DateTimeKind.Utc).AddTicks(8891),
                            LastModifiedDate = new DateTime(2022, 6, 4, 7, 30, 14, 720, DateTimeKind.Utc).AddTicks(8894),
                            Name = "Classic"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.PropertyType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PropertyTypeId = 1,
                            CreatedDate = new DateTime(2022, 6, 4, 7, 30, 14, 720, DateTimeKind.Utc).AddTicks(4988),
                            LastModifiedDate = new DateTime(2022, 6, 4, 7, 30, 14, 720, DateTimeKind.Utc).AddTicks(5826),
                            Name = "Hotel"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomCategoryId = 1,
                            CreatedDate = new DateTime(2022, 6, 4, 7, 30, 14, 721, DateTimeKind.Utc).AddTicks(977),
                            LastModifiedDate = new DateTime(2022, 6, 4, 7, 30, 14, 721, DateTimeKind.Utc).AddTicks(979),
                            Name = "Heater"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomFacility", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomFacilityId = 1,
                            CreatedDate = new DateTime(2022, 6, 4, 7, 30, 14, 720, DateTimeKind.Utc).AddTicks(9878),
                            LastModifiedDate = new DateTime(2022, 6, 4, 7, 30, 14, 720, DateTimeKind.Utc).AddTicks(9880),
                            Name = "Heater"
                        });
                });
