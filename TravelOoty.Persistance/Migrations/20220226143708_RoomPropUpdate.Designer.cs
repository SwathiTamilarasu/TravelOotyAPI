...
namespace TravelOoty.Persistance.Migrations
{
    ...
    [Migration("20220226143708_RoomPropUpdate")]
    partial class RoomPropUpdate
    {
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Amenities", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AmenitiesId = 1,
                            CreatedDate = new DateTime(2022, 2, 26, 14, 37, 7, 397, DateTimeKind.Utc).AddTicks(8885),
                            LastModifiedDate = new DateTime(2022, 2, 26, 14, 37, 7, 397, DateTimeKind.Utc).AddTicks(8893),
                            Name = "Parking"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Hotel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HotelId = new Guid("f3f73641-81eb-4e89-91f9-aa4956d6d83b"),
                            Name = "Shaaniya"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.HotelCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            HotelCategoryId = 1,
                            CreatedDate = new DateTime(2022, 2, 26, 14, 37, 7, 398, DateTimeKind.Utc).AddTicks(465),
                            LastModifiedDate = new DateTime(2022, 2, 26, 14, 37, 7, 398, DateTimeKind.Utc).AddTicks(471),
                            Name = "Classic"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.PropertyType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PropertyTypeId = 1,
                            CreatedDate = new DateTime(2022, 2, 26, 14, 37, 7, 397, DateTimeKind.Utc).AddTicks(4567),
                            LastModifiedDate = new DateTime(2022, 2, 26, 14, 37, 7, 397, DateTimeKind.Utc).AddTicks(5980),
                            Name = "Hotel"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomCategoryId = 1,
                            CreatedDate = new DateTime(2022, 2, 26, 14, 37, 7, 398, DateTimeKind.Utc).AddTicks(3493),
                            LastModifiedDate = new DateTime(2022, 2, 26, 14, 37, 7, 398, DateTimeKind.Utc).AddTicks(3499),
                            Name = "Heater"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomFacility", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomFacilityId = 1,
                            CreatedDate = new DateTime(2022, 2, 26, 14, 37, 7, 398, DateTimeKind.Utc).AddTicks(2000),
                            LastModifiedDate = new DateTime(2022, 2, 26, 14, 37, 7, 398, DateTimeKind.Utc).AddTicks(2006),
                            Name = "Heater"
                        });
                });
