...
namespace TravelOoty.Persistance.Migrations
{
    ...
    [Migration("20220430183839_PropertyPhNoCol")]
    partial class PropertyPhNoCol
    {
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Amenities", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AmenitiesId = 1,
                            CreatedDate = new DateTime(2022, 4, 30, 18, 38, 39, 137, DateTimeKind.Utc).AddTicks(1925),
                            LastModifiedDate = new DateTime(2022, 4, 30, 18, 38, 39, 137, DateTimeKind.Utc).AddTicks(1928),
                            Name = "Parking"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Hotel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HotelId = new Guid("51fd5507-2765-4b40-a815-5d5c820ebb7f"),
                            Name = "Shaaniya"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.HotelCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            HotelCategoryId = 1,
                            CreatedDate = new DateTime(2022, 4, 30, 18, 38, 39, 137, DateTimeKind.Utc).AddTicks(2527),
                            LastModifiedDate = new DateTime(2022, 4, 30, 18, 38, 39, 137, DateTimeKind.Utc).AddTicks(2530),
                            Name = "Classic"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.PropertyType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PropertyTypeId = 1,
                            CreatedDate = new DateTime(2022, 4, 30, 18, 38, 39, 137, DateTimeKind.Utc).AddTicks(526),
                            LastModifiedDate = new DateTime(2022, 4, 30, 18, 38, 39, 137, DateTimeKind.Utc).AddTicks(1084),
                            Name = "Hotel"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomCategoryId = 1,
                            CreatedDate = new DateTime(2022, 4, 30, 18, 38, 39, 137, DateTimeKind.Utc).AddTicks(3664),
                            LastModifiedDate = new DateTime(2022, 4, 30, 18, 38, 39, 137, DateTimeKind.Utc).AddTicks(3667),
                            Name = "Heater"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomFacility", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomFacilityId = 1,
                            CreatedDate = new DateTime(2022, 4, 30, 18, 38, 39, 137, DateTimeKind.Utc).AddTicks(3099),
                            LastModifiedDate = new DateTime(2022, 4, 30, 18, 38, 39, 137, DateTimeKind.Utc).AddTicks(3102),
                            Name = "Heater"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Booking", b =>
                {
                    b.HasOne("TravelOoty.Domain.Entities.Rooms", "Rooms")
                        .WithOne("Booking")
                        .HasForeignKey("TravelOoty.Domain.Entities.Booking", "RoomId")
