...
namespace TravelOoty.Persistance.Migrations
{
    ...
    [Migration("20220223174723_AddedCityProperty")]
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Amenities", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AmenitiesId = 1,
                            CreatedDate = new DateTime(2022, 2, 23, 17, 47, 22, 470, DateTimeKind.Utc).AddTicks(9478),
                            LastModifiedDate = new DateTime(2022, 2, 23, 17, 47, 22, 470, DateTimeKind.Utc).AddTicks(9484),
                            Name = "Parking"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.City", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CityId = 1,
                            CreatedDate = new DateTime(2022, 2, 23, 17, 47, 22, 471, DateTimeKind.Utc).AddTicks(2591),
                            LastModifiedDate = new DateTime(2022, 2, 23, 17, 47, 22, 471, DateTimeKind.Utc).AddTicks(2593),
                            Name = "Ooty"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Hotel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HotelId = new Guid("158ba658-af02-452d-bd4d-3bdb82c94108"),
                            Name = "Shaaniya"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.HotelCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            HotelCategoryId = 1,
                            CreatedDate = new DateTime(2022, 2, 23, 17, 47, 22, 471, DateTimeKind.Utc).AddTicks(565),
                            LastModifiedDate = new DateTime(2022, 2, 23, 17, 47, 22, 471, DateTimeKind.Utc).AddTicks(568),
                            Name = "Classic"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.PropertyType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PropertyTypeId = 1,
                            CreatedDate = new DateTime(2022, 2, 23, 17, 47, 22, 470, DateTimeKind.Utc).AddTicks(6971),
                            LastModifiedDate = new DateTime(2022, 2, 23, 17, 47, 22, 470, DateTimeKind.Utc).AddTicks(7919),
                            Name = "Hotel"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomCategoryId = 1,
                            CreatedDate = new DateTime(2022, 2, 23, 17, 47, 22, 471, DateTimeKind.Utc).AddTicks(6061),
                            LastModifiedDate = new DateTime(2022, 2, 23, 17, 47, 22, 471, DateTimeKind.Utc).AddTicks(6064),
                            Name = "Heater"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomFacility", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomFacilityId = 1,
                            CreatedDate = new DateTime(2022, 2, 23, 17, 47, 22, 471, DateTimeKind.Utc).AddTicks(1589),
                            LastModifiedDate = new DateTime(2022, 2, 23, 17, 47, 22, 471, DateTimeKind.Utc).AddTicks(1592),
                            Name = "Heater"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Rooms", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomId = 1,
                            CreatedDate = new DateTime(2022, 2, 23, 17, 47, 22, 471, DateTimeKind.Utc).AddTicks(4629),
                            LastModifiedDate = new DateTime(2022, 2, 23, 17, 47, 22, 471, DateTimeKind.Utc).AddTicks(4634),
                            Name = "Big Boss",
                            PropertyID = 0,
                            RegularPrice = "5000",
                            RoomCategoryId = 0,
