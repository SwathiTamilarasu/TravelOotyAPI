...
namespace TravelOoty.Persistance.Migrations
{
    ...
    [Migration("20220223175750_CityFk")]
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Amenities", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AmenitiesId = 1,
                            CreatedDate = new DateTime(2022, 2, 23, 17, 57, 49, 493, DateTimeKind.Utc).AddTicks(3040),
                            LastModifiedDate = new DateTime(2022, 2, 23, 17, 57, 49, 493, DateTimeKind.Utc).AddTicks(3044),
                            Name = "Parking"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.City", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CityId = 1,
                            CreatedDate = new DateTime(2022, 2, 23, 17, 57, 49, 493, DateTimeKind.Utc).AddTicks(7133),
                            LastModifiedDate = new DateTime(2022, 2, 23, 17, 57, 49, 493, DateTimeKind.Utc).AddTicks(7136),
                            Name = "Ooty"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Hotel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HotelId = new Guid("aaaf4d7a-f956-42a3-b7cd-64abe40589b0"),
                            Name = "Shaaniya"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.HotelCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            HotelCategoryId = 1,
                            CreatedDate = new DateTime(2022, 2, 23, 17, 57, 49, 493, DateTimeKind.Utc).AddTicks(4900),
                            LastModifiedDate = new DateTime(2022, 2, 23, 17, 57, 49, 493, DateTimeKind.Utc).AddTicks(4909),
                            Name = "Classic"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.PropertyType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PropertyTypeId = 1,
                            CreatedDate = new DateTime(2022, 2, 23, 17, 57, 49, 492, DateTimeKind.Utc).AddTicks(9938),
                            LastModifiedDate = new DateTime(2022, 2, 23, 17, 57, 49, 493, DateTimeKind.Utc).AddTicks(1326),
                            Name = "Hotel"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomCategoryId = 1,
                            CreatedDate = new DateTime(2022, 2, 23, 17, 57, 49, 494, DateTimeKind.Utc).AddTicks(979),
                            LastModifiedDate = new DateTime(2022, 2, 23, 17, 57, 49, 494, DateTimeKind.Utc).AddTicks(986),
                            Name = "Heater"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomFacility", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomFacilityId = 1,
                            CreatedDate = new DateTime(2022, 2, 23, 17, 57, 49, 493, DateTimeKind.Utc).AddTicks(6087),
                            LastModifiedDate = new DateTime(2022, 2, 23, 17, 57, 49, 493, DateTimeKind.Utc).AddTicks(6089),
                            Name = "Heater"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Rooms", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomId = 1,
                            CreatedDate = new DateTime(2022, 2, 23, 17, 57, 49, 493, DateTimeKind.Utc).AddTicks(9230),
                            LastModifiedDate = new DateTime(2022, 2, 23, 17, 57, 49, 493, DateTimeKind.Utc).AddTicks(9235),
                            Name = "Big Boss",
                            PropertyID = 0,
                            RegularPrice = "5000",
                            RoomCategoryId = 0,
