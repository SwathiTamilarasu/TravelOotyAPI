...
namespace TravelOoty.Persistance.Migrations
{
    ...
    [Migration("20220814072044_RoombookingEntityUpdate")]
    partial class RoombookingEntityUpdate
    {
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Amenities", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AmenitiesId = 1,
                            CreatedDate = new DateTime(2022, 8, 14, 7, 20, 43, 332, DateTimeKind.Utc).AddTicks(3582),
                            LastModifiedDate = new DateTime(2022, 8, 14, 7, 20, 43, 332, DateTimeKind.Utc).AddTicks(3586),
                            Name = "Parking"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Hotel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HotelId = new Guid("486d1bce-f80e-4bac-907c-e4abce28da5b"),
                            Name = "Shaaniya"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.HotelCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            HotelCategoryId = 1,
                            CreatedDate = new DateTime(2022, 8, 14, 7, 20, 43, 332, DateTimeKind.Utc).AddTicks(4577),
                            LastModifiedDate = new DateTime(2022, 8, 14, 7, 20, 43, 332, DateTimeKind.Utc).AddTicks(4580),
                            Name = "Classic"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.PropertyType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PropertyTypeId = 1,
                            CreatedDate = new DateTime(2022, 8, 14, 7, 20, 43, 332, DateTimeKind.Utc).AddTicks(1356),
                            LastModifiedDate = new DateTime(2022, 8, 14, 7, 20, 43, 332, DateTimeKind.Utc).AddTicks(2139),
                            Name = "Hotel"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomCategoryId = 1,
                            CreatedDate = new DateTime(2022, 8, 14, 7, 20, 43, 332, DateTimeKind.Utc).AddTicks(6507),
                            LastModifiedDate = new DateTime(2022, 8, 14, 7, 20, 43, 332, DateTimeKind.Utc).AddTicks(6510),
                            Name = "Heater"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomFacility", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomFacilityId = 1,
                            CreatedDate = new DateTime(2022, 8, 14, 7, 20, 43, 332, DateTimeKind.Utc).AddTicks(5589),
                            LastModifiedDate = new DateTime(2022, 8, 14, 7, 20, 43, 332, DateTimeKind.Utc).AddTicks(5592),
                            Name = "Heater"
                        });
                });
