...
namespace TravelOoty.Persistance.Migrations
{
    ...
    [Migration("20220703040237_RoomPropertyUpdate")]
    partial class RoomPropertyUpdate
    {
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Amenities", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AmenitiesId = 1,
                            CreatedDate = new DateTime(2022, 7, 3, 4, 2, 36, 374, DateTimeKind.Utc).AddTicks(5145),
                            LastModifiedDate = new DateTime(2022, 7, 3, 4, 2, 36, 374, DateTimeKind.Utc).AddTicks(5152),
                            Name = "Parking"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Hotel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HotelId = new Guid("ff69fa50-49e8-4d41-9834-c4dd9baebdde"),
                            Name = "Shaaniya"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.HotelCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            HotelCategoryId = 1,
                            CreatedDate = new DateTime(2022, 7, 3, 4, 2, 36, 374, DateTimeKind.Utc).AddTicks(6714),
                            LastModifiedDate = new DateTime(2022, 7, 3, 4, 2, 36, 374, DateTimeKind.Utc).AddTicks(6718),
                            Name = "Classic"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.PropertyType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PropertyTypeId = 1,
                            CreatedDate = new DateTime(2022, 7, 3, 4, 2, 36, 374, DateTimeKind.Utc).AddTicks(2280),
                            LastModifiedDate = new DateTime(2022, 7, 3, 4, 2, 36, 374, DateTimeKind.Utc).AddTicks(3210),
                            Name = "Hotel"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomCategoryId = 1,
                            CreatedDate = new DateTime(2022, 7, 3, 4, 2, 36, 374, DateTimeKind.Utc).AddTicks(8980),
                            LastModifiedDate = new DateTime(2022, 7, 3, 4, 2, 36, 374, DateTimeKind.Utc).AddTicks(8983),
                            Name = "Heater"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomFacility", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomFacilityId = 1,
                            CreatedDate = new DateTime(2022, 7, 3, 4, 2, 36, 374, DateTimeKind.Utc).AddTicks(7961),
                            LastModifiedDate = new DateTime(2022, 7, 3, 4, 2, 36, 374, DateTimeKind.Utc).AddTicks(7964),
                            Name = "Heater"
                        });
                });
