...
namespace TravelOoty.Persistance.Migrations
{
    ...
    [Migration("20230402113446_promocode")]
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Amenities", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AmenitiesId = 1,
                            CreatedDate = new DateTime(2023, 4, 2, 11, 34, 46, 216, DateTimeKind.Utc).AddTicks(6457),
                            LastModifiedDate = new DateTime(2023, 4, 2, 11, 34, 46, 216, DateTimeKind.Utc).AddTicks(6459),
                            Name = "Parking"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Hotel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HotelId = new Guid("a4db8f7c-06d7-4b1b-b0dd-248491d5efe9"),
                            Name = "Shaaniya"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.HotelCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            HotelCategoryId = 1,
                            CreatedDate = new DateTime(2023, 4, 2, 11, 34, 46, 216, DateTimeKind.Utc).AddTicks(7047),
                            LastModifiedDate = new DateTime(2023, 4, 2, 11, 34, 46, 216, DateTimeKind.Utc).AddTicks(7049),
                            Name = "Classic"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.PropertyType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PropertyTypeId = 1,
                            CreatedDate = new DateTime(2023, 4, 2, 11, 34, 46, 216, DateTimeKind.Utc).AddTicks(5031),
                            LastModifiedDate = new DateTime(2023, 4, 2, 11, 34, 46, 216, DateTimeKind.Utc).AddTicks(5595),
                            Name = "Hotel"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomCategoryId = 1,
                            CreatedDate = new DateTime(2023, 4, 2, 11, 34, 46, 216, DateTimeKind.Utc).AddTicks(8145),
                            LastModifiedDate = new DateTime(2023, 4, 2, 11, 34, 46, 216, DateTimeKind.Utc).AddTicks(8146),
                            Name = "Heater"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomFacility", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomFacilityId = 1,
                            CreatedDate = new DateTime(2023, 4, 2, 11, 34, 46, 216, DateTimeKind.Utc).AddTicks(7603),
                            LastModifiedDate = new DateTime(2023, 4, 2, 11, 34, 46, 216, DateTimeKind.Utc).AddTicks(7605),
                            Name = "Heater"
                        });
                });
