...
namespace TravelOoty.Persistance.Migrations
{
    ...
    [Migration("20220813020215_bookingAddAduitEntity")]
    partial class bookingAddAduitEntity
    {
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Amenities", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AmenitiesId = 1,
                            CreatedDate = new DateTime(2022, 8, 13, 2, 2, 14, 263, DateTimeKind.Utc).AddTicks(4015),
                            LastModifiedDate = new DateTime(2022, 8, 13, 2, 2, 14, 263, DateTimeKind.Utc).AddTicks(4020),
                            Name = "Parking"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.Hotel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HotelId = new Guid("99b3a655-4a57-4285-bef1-56140457a651"),
                            Name = "Shaaniya"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.HotelCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            HotelCategoryId = 1,
                            CreatedDate = new DateTime(2022, 8, 13, 2, 2, 14, 263, DateTimeKind.Utc).AddTicks(5221),
                            LastModifiedDate = new DateTime(2022, 8, 13, 2, 2, 14, 263, DateTimeKind.Utc).AddTicks(5225),
                            Name = "Classic"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.PropertyType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PropertyTypeId = 1,
                            CreatedDate = new DateTime(2022, 8, 13, 2, 2, 14, 263, DateTimeKind.Utc).AddTicks(944),
                            LastModifiedDate = new DateTime(2022, 8, 13, 2, 2, 14, 263, DateTimeKind.Utc).AddTicks(2112),
                            Name = "Hotel"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomCategoryId = 1,
                            CreatedDate = new DateTime(2022, 8, 13, 2, 2, 14, 263, DateTimeKind.Utc).AddTicks(7772),
                            LastModifiedDate = new DateTime(2022, 8, 13, 2, 2, 14, 263, DateTimeKind.Utc).AddTicks(7775),
                            Name = "Heater"
                        });
                });
            ...
            modelBuilder.Entity("TravelOoty.Domain.Entities.RoomFacility", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoomFacilityId = 1,
                            CreatedDate = new DateTime(2022, 8, 13, 2, 2, 14, 263, DateTimeKind.Utc).AddTicks(6512),
                            LastModifiedDate = new DateTime(2022, 8, 13, 2, 2, 14, 263, DateTimeKind.Utc).AddTicks(6516),
                            Name = "Heater"
                        });
                });
