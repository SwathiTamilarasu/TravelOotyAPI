...
{
    public class HotelCategoryRepository: BaseRepository<HotelCategory>, IHotelCategoryRepository
    {
        public HotelCategoryRepository(TravelOotyDbContext dbContext) : base(dbContext)
        {
